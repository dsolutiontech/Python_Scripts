...
def create_user(username, password, user_type):
    ...
    try: # Try to create the new user
        ...
        logger.info(f"{user_type.capitalize()} '{username}' created successfully with home directory '{home_dir}'.") # Log the user creation
        print(f"{user_type.capitalize()} '{username}' created successfully.") # Print a success message
